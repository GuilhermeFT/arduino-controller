 ...
 * [SerialFragment.OnFragmentInteractionListener] interface
...
class SerialFragment : Fragment() {
    ...
    fun sendClass(mainActivity: MainActivity) {
        ma = mainActivity
    }
    ...
    override fun onCreateView(
        ...
        var v : View = inflater.inflate(R.layout.fragment_serial, container, false)
